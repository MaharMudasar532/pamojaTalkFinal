...
const Team = () => {
  ...
  const handleDelete = async () => {
    var InsertAPIURL = `${url}ads/delete`
    var headers = {
  ...
  const columns = [
    ...
    {
      field: 'link', headerName: <span style={{ color: "black", fontWeight: 600 }}>Link</span>,
      minWidth: 300, flex: '1'
    },
  ...
  const getAllLogos = async () => {
    setIsloading(true);
    var InsertAPIURL = `${url}ads/view_all`
    var headers = {
      'Accept': 'application/json',
      'Content-Type': 'application/json',
    };
        ...
        <Grid container pt={{ lg: 2, xl: 1 }} >
          ...
          <Grid item md={2.7} xs={12} align="right">
            <div style={{ display: 'flex', justifyContent: 'right', alignItems: 'right', gap: '10px', width: '100%' }}>
              ...
              <button onClick={() => navigate("/addexercise")} style={{
        ...
        >
          <Box width={{ xs: 400, md: 500, lg: 600, xl: 650 }} height="auto" sx={styleview}>
            ...
            <Grid xs={12} align="center" pt={3}>
              {viewData.image !== null ?
                <img alt="" src={`${url}${viewData.image}`} style={{ bgcolor: "#B5030B", width: '175px', height: '175px' }}>
                </img>
                :
